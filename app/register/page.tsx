          ...
          <div className="relative hidden lg:flex flex-col justify-between p-12 lg:col-span-2 bg-gradient-to-b from-gray-900/50 to-gray-950/50 border-r border-gray-800">
            ...
            <div className="relative">
              ...
              <p className="mt-4 text-gray-400 text-base leading-relaxed">
                The ultimate productivity and earnings companion designed specifically for part-time workers in Japan.
              </p>
            </div>
            ...
            <div className="relative space-y-5 mt-12">
              {[
                { icon: "🎯", title: "Legal 28-Hour Limit", desc: "Stay compliant automatically" },
                { icon: "💴", title: "Smart Earnings Calc", desc: "Real-time shifts & wage math" },
                { icon: "🌙", title: "Night Shift Premium", desc: "Auto-adds premium multipliers" },
                { icon: "📊", title: "Savings Ecosystem", desc: "Set goals, watch your progress" }
              ].map((item, idx) => (
          ...
          <div className="p-8 sm:p-12 lg:col-span-3 flex flex-col justify-center bg-gray-900/10">
            <div className="mx-auto w-full max-w-md">
              ...
              <p className="mt-2 text-sm text-gray-400">
                Start tracking your work hours, optimization limits, and goals.
              </p>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <select
                      name="currency"
                      defaultValue="¥"
                      className="h-12 w-full appearance-none rounded-xl border border-gray-800 bg-gray-950/50 px-4 text-sm text-white outline-none transition duration-200 focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30"
                    >
                      <option value="¥" className="bg-gray-900">¥ Japanese Yen (JPY)</option>
                      <option value="₹" className="bg-gray-900">₹ Indian Rupee (INR)</option>
                      <option value="$" className="bg-gray-900">$ US Dollar (USD)</option>
                      <option value="€" className="bg-gray-900">€ Euro (EUR)</option>
                      <option value="£" className="bg-gray-900">£ British Pound (GBP)</option>
                    </select>
